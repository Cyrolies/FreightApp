...
import { PowerBISettings, EmbedConfig, Profile } from './../../../providers/freight-api.service';
...
@Component({
  selector: 'page-about',
  templateUrl: 'freightmilestone.html',
  encapsulation: ViewEncapsulation.None
})
export class FreightMilestonePage implements OnInit, OnDestroy {
...
console.log(this.selectedProfile.CargoWiseCode);
    powerBISettings.UserID = this.selectedProfile.CargoWiseCode;

    powerBISettings.RoleName = 'FreightMilestones_All';
    powerBISettings.ReportID = 'f5be1dbf-67d2-438d-abc7-33c60b8a6735'; // 'f38b008e-5b6d-4520-8821-bcde389c1807';
    ...
    //  console.log(accessToken);
      ...
      console.log(error);
      this.presentToast('Failed to fetch Report from Server. Please try again later.');
    });
